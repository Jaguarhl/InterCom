// RoomsFS.cpp : implementation file
//
...
CRoomsFS::CRoomsFS(CWnd* pParent /*=NULL*/)
	: CDialog(CRoomsFS::IDD, pParent)
{
	//{{AFX_DATA_INIT(CRoomsFS)
	//}}AFX_DATA_INIT
}

CRoomsFS::CRoomsFS(CView* pView)
{
	m_pView = pView;
	m_pDial = this;
...
void CRoomsFS::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CRoomsFS)
	DDX_Control(pDX, IDC_WROOMS, m_wrooms);
	DDX_Control(pDX, IDC_RENTERS, m_renters);
	DDX_Control(pDX, IDC_NEIGHBOURS, m_neighbours);
...
BEGIN_MESSAGE_MAP(CRoomsFS, CDialog)
	//{{AFX_MSG_MAP(CRoomsFS)
	ON_WM_ACTIVATE()
...
/////////////////////////////////////////////////////////////////////////////
// CRoomsFS message handlers

BOOL CRoomsFS::Create() 
{
	// TODO: Add your specialized code here and/or call the base class
	return CDialog::Create(CRoomsFS::IDD);
}

void CRoomsFS::OnCancel() 
{
	// TODO: Add extra cleanup here
	m_pView->PostMessage(WM_ENDOFDIAL);
}

void CRoomsFS::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
...
//	cur=TRUE;
	...
	m_rooms.LimitText(2);
	m_wrooms.LimitText(2);
	m_renters.LimitText(1);
	m_neighbours.LimitText(1);
...
void CRoomsFS::OnFirst() 
{
	// TODO: Add your control notification handler code here
	m_pView->PostMessage(WM_MFIRST);
}

void CRoomsFS::OnSelchangeAgent() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CRoomsFS::OnSelchangePhone() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CRoomsFS::OnChangeSgeneral() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnChangeSkitchen() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnChangeBuildingend() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnChangeCostfrom() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnChangeDescription() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnChangeDistance() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CRoomsFS::OnSelchangeDistrict() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CRoomsFS::OnSelchangeForwhat() 
{
	// TODO: Add your control notification handler code here
	CString s="";
...
void CRoomsFS::OnSelchangeHousetype() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CRoomsFS::OnSelchangeInwhat() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CRoomsFS::OnSelchangeMetro() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
