// FlatsInBH.cpp : implementation file
//
...
CFlatsInBH::CFlatsInBH(CWnd* pParent /*=NULL*/)
	: CDialog(CFlatsInBH::IDD, pParent)
{
	//{{AFX_DATA_INIT(CFlatsInBH)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}

CFlatsInBH::CFlatsInBH(CView* pView)
{
	m_pView = pView;
	m_pDial = this;
...
void CFlatsInBH::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CFlatsInBH)
	...
	DDX_Control(pDX, IDC_BUILDINGEND, m_buildingend);
...
BEGIN_MESSAGE_MAP(CFlatsInBH, CDialog)
	//{{AFX_MSG_MAP(CFlatsInBH)
	ON_WM_ACTIVATE()
	...
	ON_EN_CHANGE(IDC_BUILDINGEND, OnChangeBuildingend)
...
/////////////////////////////////////////////////////////////////////////////
// CFlatsInBH message handlers

BOOL CFlatsInBH::Create() 
{
	// TODO: Add your specialized code here and/or call the base class
	return CDialog::Create(CFlatsInBH::IDD);
}

void CFlatsInBH::OnCancel() 
{
	// TODO: Add extra cleanup here
	m_pView->PostMessage(WM_ENDOFDIAL);
}

void CFlatsInBH::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
...
void CFlatsInBH::OnFirst() 
{
	// TODO: Add your control notification handler code here
	m_pView->PostMessage(WM_MFIRST);
}

void CFlatsInBH::OnSelchangeAgent() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CFlatsInBH::OnSelchangePhone() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CFlatsInBH::OnChangeSgeneral() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeSkitchen() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeAddress() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeBuildingend() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeCostfrom() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeDescription() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnChangeDistance() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnSelchangeDistrict() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CFlatsInBH::OnChangeFloors() 
{
	// TODO: If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
...
void CFlatsInBH::OnSelchangeForwhat() 
{
	// TODO: Add your control notification handler code here
	CString s="";
...
void CFlatsInBH::OnSelchangeHousetype() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CFlatsInBH::OnSelchangeInwhat() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
void CFlatsInBH::OnSelchangeMetro() 
{
	// TODO: Add your control notification handler code here
	m_save.EnableWindow();
...
BOOL CFlatsInBH::CheckEntry()
{
	...
	s="";
	m_buildingend.GetWindowText(s);
	if(s.IsEmpty())
	{
		error+="необходимо указать срок окончания строительтва в соответствующем поле |";
	}
